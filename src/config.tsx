...
const titleDefault = 'Jose - Developer'
const url = 'https://joseok.dev/'
const description =
  'Jose is a developer, writer and speaker. He is a digital nomad and travels around the world while working remotely.'
const author = 'Jose'
